...
public class MainPresenter {
	...
	private RecipeModel getRecipeStub(){
		RecipeModel model = new RecipeModel();
		model.setName("Jajecznica po studencku");
		model.setDescription(
				"Jajecznica po studencku jest popularna wśród " +
				"biednych studenciaków bo jest tania");
		model.setInstructions(
				"1. Podejdź do lodówki" + System.getProperty("line.separator") +
				"2. Otwórz lodówkę" + System.getProperty("line.separator") +
				"3. Podrap się po jajkach" + System.getProperty("line.separator") +
				"4. Zamknij lodówkę");
	...
	public void refreshRecipe(IRecipeView recipeView, int recipeId){
		recipeView.setRecipeName(this.recipes.get(recipeId).getName());
	}
}
