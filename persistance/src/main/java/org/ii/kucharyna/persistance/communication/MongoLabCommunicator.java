...
public class MongoLabCommunicator {
  ...
  public String sendReceive(MongoRequest request)
    ...
    if (request == null)
      throw new IllegalArgumentException(
          "MongoLabCommunicator#sendReceive: request cannot be null");
    ...
    while (true) {
      try {
        ...
        getLogger().info(
            "MongoLabCommunicator#sendReceive: sending request: "
                + System.getProperty("line.separator")
                + httpRequest.getURI().toString());
        HttpResponse response = httpClient.execute(request.getHttpRequest());
    ...
    getLogger().info(
        "MongoLabCommunicator#sendReceive: received response: "
            + System.getProperty("line.separator") + responseString);
  ...
  void setConnectionTimeout(int millis) {
    HttpConnectionParams.setConnectionTimeout(httpClient.getParams(), millis);
  }
}
